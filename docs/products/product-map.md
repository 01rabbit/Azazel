...
- **Defensive implementation layer:** [Azazel-Edge Gateway](https://github.com/01rabbit/Azazel-Edge) (AZ-01), [Azazel-Gadget Shield](https://github.com/01rabbit/Azazel-Gadget) (AZ-02), and reserved Azazel-Boot Probe (AZ-03)
