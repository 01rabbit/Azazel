...
- `01rabbit/Azazel-Knowledge` (AZ-04, formerly Azazel-CTI): advisory-only, deterministic on-premises tactical CTI node, `Azazel-Knowledge Advisor`
- `01rabbit/Azazel-Fabric` (AZ-05, formerly Azazel-Common): shared contracts library for the series, `Azazel-Fabric Contract`
